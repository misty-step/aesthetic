...
<link
  rel="stylesheet"
  href="https://cdn.jsdelivr.net/gh/misty-step/aesthetic@v2.5.1/aesthetic.css"
/>
```
...
```bash
pnpm add github:misty-step/aesthetic#v2.5.1
```
...
```html
<script src="https://cdn.jsdelivr.net/gh/misty-step/aesthetic@v2.5.1/recipes/recipes.js"></script>
```
