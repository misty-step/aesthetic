...
export async function checkFontSize(page, max = 16) {
...
export async function checkRadius(page) {
...
/* 3. no page scroll: the page itself never scrolls; stages and desks
      scroll inside. */
export async function checkNoPageScroll(page) {
...
/* 4. static text keeps the default cursor (no I-beam on non-interactive
      elements). */
export async function checkCursorDefault(page) {
...
export function checkConsoleClean(errors) {
...
export async function checkAll(page, opts = {}) {
